package org.knowyourdenfender.enhelper.thirdParty;
...
public class YoudaoTranslate {
    ...
    public static HashMap<String, String> requestForHttp(String url, Map<String, String> params) throws IOException {
        ...
        try {
            ...
            if ("audio/mp3".equals(contentType[0].getValue())) {
                //如果响应是wav
                //那就不做处理
                logger.info("Audio file response.");
...
//                }
            ...
            try {
                ...
                logger.info("## release resource error ##" + e);
            }
        }
    }
